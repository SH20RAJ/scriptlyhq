...
export default function CartPage() {
  ...
  if (!mounted) {
    return (
      <div className="container max-w-7xl mx-auto px-4 py-24 flex items-center justify-center min-h-[50vh]">
  ...
  if (cartCount === 0) {
    return (
      <div className="container max-w-xl mx-auto px-4 py-24 text-center space-y-6">
  ...
  return (
    <div className="container max-w-7xl mx-auto px-4 py-12 md:py-20">
      <div className="flex flex-col gap-2 border-b border-border/60 pb-8 mb-12">
        ...
        <p className="text-sm text-muted-foreground font-medium">{cartCount} premium digital products selected.</p>
      </div>
